...
<body>
    <form action="addcustomer.php" method="post">
        <table border="0" cellspacing="1" cellpadding="3">
            <tr><td colspan="2" align="center"><h4>Enter your information</h4></td></tr>
            ...
            <tr><td>Zip Code: </td><td><input size="20" type="number" name="zipcode"></td></tr>
            <tr><td>Phone No: </td><td><input size="30" type="number" name="phone_no"></td></tr>
